...
public class boardDto {
	...
	public boardDto(int brdno, int bcategoryno, String brdwriter, String brdfile, String brdfilename,
			String brdthumbfile, String brdcontent, int brdcount, Date brddate, String brdprivate, int memno,
			String memnick) {
		super();
		this.brdno = brdno;
