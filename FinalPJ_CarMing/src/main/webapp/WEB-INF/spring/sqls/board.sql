...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=4), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'carcamp17.png',DEFAULT,'게시글 내용4',0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=3), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'glam10.jpg','썸네일5.jpg','게시글 내용5',0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
...
VALUES (MAPNOSEQ.NEXTVAL, '차박_부산 오랑대 공원', '35.20583361583557', '129.22770710083566', 'Y', 1, 1);, 
INSERT INTO MAPLOCATION 
VALUES (MAPNOSEQ.NEXTVAL, '차박_충남 금상 기러기공원', '36.11694175876809', '127.59191472272603', 'Y', 1, 2);
