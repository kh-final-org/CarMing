...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 2, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'mycamp18.JPG','게시글 내용1',0,SYSDATE,'N');
INSERT INTO BOARD
...
CREATE TABLE PRACTICE_BOARD(
	...
	CONTENT CARCHAR2(100) NOT NULL,
	GNO NUMBER NOT NULL,
	STEP NUMBER NOT NULL,
	INDENT NUMBER NOT NULL,
	CONUT NUMBER NOT NULL,
	BDATE DATE
);
...
CREATE TABLE COMMENTS(
	...
	CDATE DATE,
	CONSTRAINT FK_BNO FOREIGN KEY (BNO) REFERENCES BOARD(NO) 
);
