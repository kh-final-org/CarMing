...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 2, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'caravan7-1.jpg','게시글 내용1',0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
...
/* (MEMNO=1)이 올린 게시글 이미지 (나만보기 체크 x)  */
SELECT B.BRDFILE, B.BRDPRIVATE, M.MEMNICK, M.MEMNO
FROM BOARD B, MEMBER M
WHERE B.BRDWRITER = M.MEMNICK AND B.BRDPRIVATE='N' AND M.MEMNO = 1;

/* (BOARD + BCATEGORY) JOIN */
