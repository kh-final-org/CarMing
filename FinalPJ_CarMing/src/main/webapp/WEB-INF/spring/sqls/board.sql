...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 2, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'caravan7-1.jpg','게시글 내용1',0,0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 5, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'mycamp18.JPG','게시글 내용2',0,0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 4, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'carcamp14-1.jpg','게시글 내용3',0,0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 4, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'carcamp17.png','게시글 내용4',0,0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 3, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'glam10.jpg','게시글 내용5',0,0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));

/* (MEMNO=1)이 올린 게시글 이미지  */
SELECT B.BRDFILE, M.MEMNICK, M.MEMNO
FROM BOARD B, MEMBER M
WHERE B.BRDWRITER = M.MEMNICK AND M.MEMNO = 1;
