...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=1), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'caravan9.jpg','게시글 내용1',0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=5), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'mycamp18.JPG','게시글 내용2',0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=4), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'carcamp14-1.jpg','게시글 내용3',0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=4), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'carcamp17.png','게시글 내용4',0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, (SELECT BCATEGORYNO FROM BCATEGORY WHERE BCATEGORYNO=3), (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'glam10.jpg','게시글 내용5',0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));
