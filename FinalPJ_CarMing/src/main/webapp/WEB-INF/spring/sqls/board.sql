...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 2, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'caravan7-1.jpg','게시글 내용1',0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=1));
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 5, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'mycamp18.JPG','게시글 내용2',0,SYSDATE,'Y',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));
INSERT INTO BOARD
...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 3, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'glam10.jpg','게시글 내용5',0,SYSDATE,'N',(SELECT MEMNO FROM MEMBER WHERE MEMNO=2));
