...
VALUES(MEMNOSEQ.NEXTVAL,'nick1','user1@naver.com','pw1','사용자1',
        '우편번호','기본주소','상세주소','010-1111-2222',DATE '2013-02-17','1','N','2',NULL);
INSERT INTO MEMBER
VALUES(MEMNOSEQ.NEXTVAL,'user911','user2@naver.com','pw2','사용자2',
		'우편번호','기본주소','상세주소','010-2221-5556',DATE '2013-02-17','1','Y','2',NULL);
...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 2, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'carcamp15.jpg','게시글 내용1',0,0,SYSDATE,'N');
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 5, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'carcamp17.png','게시글 내용2',0,0,SYSDATE,'Y');
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 4, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'caravan6.jpg','게시글 내용3',0,0,SYSDATE,'N');
INSERT INTO BOARD
