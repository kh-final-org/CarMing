...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 2, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'carcamp15.jpg','게시글 내용1',0,SYSDATE,'N');
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 5, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'carcamp17.png','게시글 내용2',0,SYSDATE,'Y');
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 4, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=1),'caravan6.jpg','게시글 내용3',0,SYSDATE,'N');
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 4, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'mycamp18.JPG','게시글 내용4',0,SYSDATE,'Y');
