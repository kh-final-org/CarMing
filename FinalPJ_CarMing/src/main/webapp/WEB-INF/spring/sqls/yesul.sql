...
CREATE TABLE REPORTLIST(
	...
	CONSTRAINT FK_MEMNO_REPORT FOREIGN KEY (MEMNO) references MEMBER(MEMNO),
    CONSTRAINT FK_CATEGORYNO_REPORT FOREIGN KEY (CATEGORYNO) references REPORTCATEGORY(CATEGORYNO)
	 );
   ALTER TABLE REPORTLIST DROP CONSTRAINT FK_MEMNO_REPORT
    
    ALTER TABLE REPORTLIST
	ADD CONSTRAINT FK_MEMNO_REPORT
	FOREIGN KEY (MEMNO)
