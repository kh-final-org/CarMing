...
INSERT INTO MEMBER (MEMNO, MEMNICK, MEMID, MEMPW, MEMNAME, MEMZIP, MEMADDR, MEMADDR2, MEMPHONE, MEMBIRTH, MEMGENDER, MEMCHK) 
VALUES(MEMSEQ.NEXTVAL, '관리자', 'admin1', 'adminpass1', '김유리', '54678', '경기도 화성시', '어딘가', '01078941234', DATE '2013-02-17', '2', 'N');
...
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 5, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=2),'carcamp17.png','게시글 내용2',0,0,SYSDATE,'Y');
INSERT INTO BOARD
VALUES(BRDNOSEQ.NEXTVAL, 4, (SELECT MEMNICK FROM MEMBER WHERE MEMNO=3),'caravan6.jpg','게시글 내용3',0,0,SYSDATE,'N');
INSERT INTO BOARD
...
VALUES(COMNOSEQ.NEXTVAL, (SELECT MEMNAME FROM MEMBER WHERE MEMNO=2), '게시글1-댓글1', SYSDATE, 1);
INSERT INTO BCOMMENT
VALUES(COMNOSEQ.NEXTVAL, (SELECT MEMNAME FROM MEMBER WHERE MEMNO=3), '게시글1-댓글2', SYSDATE, 1);

/* (BRDNO=2)인 게시글에 댓글 달기 */
INSERT INTO BCOMMENT
VALUES(COMNOSEQ.NEXTVAL, (SELECT MEMNAME FROM MEMBER WHERE MEMNO=2), '게시글2-댓글1', SYSDATE, 2);
...
VALUES(SEQINQUIRY.NEXTVAL,(SELECT MEMNO FROM MEMBER WHERE MEMNO=2),'DD','DD', DEFAULT, 3);
...
INSERT INTO REPORTCATEGORY
VALUES(SEQREPCATEGORY.NEXTVAL,'거래');


INSERT INTO REPORTCATEGORY
VALUES(SEQREPCATEGORY.NEXTVAL,'언어');
