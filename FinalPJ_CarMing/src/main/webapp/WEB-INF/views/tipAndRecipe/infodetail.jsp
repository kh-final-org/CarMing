			...
			<div
				...
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="category.html">핑구 꿀팁</a>
					</nav>
				</div>
			</div>
			<div class="section-top-border text-right">
				<div class="button-group-area mt-40" style="padding-bottom: 5em">
					<a href="tipAndRecipeMain.do" class="genric-btn danger-border e-large">목록으로</a>
				</div>
			</div>
		</div>
	</section>
							...
							<div
								...
								<div class="thumb">
									<a href="#"><img class="img-fluid"
										src="resources/img/logo.png" style="width: 4em; height: 4em;"
										alt=""></a>
								</div>
								<div class="arrow">
