            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        <a href="tipAndRecipeMain.do">핑구 추천<span class="lnr lnr-arrow-right"></span></a>
                        <a href="category.html">핑구 레시피</a>
                    </nav>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-post row">
                        <div class="col-lg-13">
                            <div class="feature-img">
                                <img class="img-fluid" src="resources/img/banner/banner-bg.jpg"  style="width: 80em; height: 40em;  margin-left: auto; margin-right: auto; display: block;"      alt="">
                            </div>
                            <br><br>
                        </div>
                        <div class="col-lg-2  col-md-6">
                            <div class="blog_info text-right">
                                <div class="post_tag">
                                <br><br><br>
                                 <a class="active" href="#"><b>카밍꿀팁</b></a>
                                </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="resources/img/logo.png"  style="width: 4em; height: 4em;"     alt=""></a>
                                </div>
                                <div class="arrow">
