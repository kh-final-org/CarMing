				...
				<div class="col-md-9">
					<div class="contact-form">
						...
						<div class="form-group-category-form">
							...
							<div class="inquiry-err" id="emptycategory">카테고리를 선택해주세요.</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="inquiry-err" id="emptycontent">문의 내용을 작성해주세요.</div>
						</div>
						...
						<div class="inquiry-err" id="emptyfile">사진을 선택해주세요.</div>
