...
<style type="text/css">
	...
	.content-form{max-width: 80%; border: 1px solid #e2e2e2; border-radius: 10px; padding: 30px 0px; background: #fff5e9;}
	h4{padding-left: 77px; text-align: left; margin: 10px; color: #5f5f5f;}
	.content-panel{width: 80%; padding: 15px 20px; border: 1px solid #ccc; border-radius: 5px; 
				   background: #fafafa; color: gray;} 
	.content-panel-text{font-size: 0.8em; text-align: left;}
	
	.checkbox input{display: none;}
	.checkbox span{display: inline-block; vertical-align: middle; cursor: pointer;}
	.checkbox .icon{position: relative; width: 20px; height: 20px; border: 2px solid silver; background: #fff; border-radius: 3px; transition: background 0.1s ease;}
	.checkbox .icon::after{content: ''; position: absolute; top: 1px; left: 6px; width: 6px; height: 11px; border-right: 2px solid #fff;
